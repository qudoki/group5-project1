...
//This was generated from Spotify based on a query of "sad", we can build objects from these and make a randomizer function that takes from them. This will need to eventually reference the separate js files.
var moodSadData = {
  "tracks": {
